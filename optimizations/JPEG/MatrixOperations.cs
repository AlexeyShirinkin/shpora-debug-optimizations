...
namespace JPEG
{
    internal static class MatrixOperations
    {
        ...
        public static void SetPixels(Matrix matrix, double[,] a, double[,] b, double[,] c, PixelFormat format, int yOffset, int xOffset)
        {
        ...
        public static double[,] GetSubMatrix(Matrix matrix, int yOffset, int yLength, int xOffset, int xLength, Func<Pixel, double> componentSelector)
        {
        ...
        public static IEnumerable<byte> ZigZagScan(byte[,] channelFreqs)
        {
            return new[]
            {
        ...
        public static byte[,] ZigZagUnScan(IReadOnlyList<byte> quantizedBytes)
        {
            return new[,]
            {
